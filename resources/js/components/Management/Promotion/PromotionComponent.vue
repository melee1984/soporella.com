...
<script>
    ...
    export default {
      ...
      methods: {
        fetchData: function() {
          var self = this;
          axios.get('/api/management/promotion/list?api_token='+api_token).then(function (response) {
        ...
        updateMenu: function(obj) {
          var self = this;
          axios.post('/api/management/promotion/'+obj.id+'/add/submit?api_token='+api_token).then(function (response) {
